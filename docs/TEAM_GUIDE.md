...
**2. Content Writer (Execution)** takes your topic through five phases: interactive intake questions, web research for current data, template selection, drafting with anti-AI rules applied during writing, and handoff with a summary of evidence cited and any gaps.
...
Claude presents two rounds of multiple-choice questions before writing:

| Round | Question | Options |
|-------|----------|---------|
| Round 1 | Audience | L&D Director, Trainer, CHRO, CTO |
| | Vertical | Corporate, Government, Healthcare, Training Providers |
| | Content Goal | Educate, Persuade, Showcase, Announce |
| | Class Positioning | Soft, Strong, Neutral, None |
| Round 2 | Format | Blog post, Customer story, Guide, Short-form |
| | Solution Pillars | Before, During, After Training, Foundation |
| | Proof Points | I'll provide, Use published, Skip for now |

Every question includes an "Other" option for custom input. After both rounds, Claude summarizes your brief and confirms before writing.
...
| Content Writer | SKILL.md + 3 reference files | 5-phase process, 4 templates, writing checklist, headline formulas, hook patterns, interactive intake |
